...
Definition preserved_with_inv1 Q R :=
  forall x, G (fun x => P x /\ Q x /\ R x) x -> Q x.
...
Ltac prove_ind1 :=
  ...
  match goal with [ |- ?G1_ /\ ?G2_ /\ ?G3_ ] =>
    pose (G1 := G1_);
    pose (Hmap := (ltac:(intros Q R H x Hx; destruct Hx; constructor; try assumption; apply H; assumption) : G1));
    split; [exact Hmap|];
...
Definition preserved_with_inv2 Q R :=
  forall x y, G (fun x y => P x y /\ Q x y /\ R x y) x y -> Q x y.
...
Ltac prove_ind2 :=
  ...
  match goal with [ |- ?G1_ /\ ?G2_ /\ ?G3_ ] =>
    pose (G1 := G1_);
    pose (Hmap := (ltac:(intros Q R H x y Hxy; destruct Hxy; constructor; try assumption; apply H; assumption) : G1));
    split; [exact Hmap|];
...
Definition preserved_with_inv3 Q R :=
  forall x y z, G (fun x y z => P x y z /\ Q x y z /\ R x y z) x y z -> Q x y z.
...
Ltac prove_ind3 :=
  ...
  match goal with [ |- ?G1_ /\ ?G2_ /\ ?G3_ ] =>
    pose (G1 := G1_);
    pose (Hmap := (ltac:(intros Q R H x y z Hxyz; destruct Hxyz; constructor; try assumption; apply H; assumption) : G1));
    split; [exact Hmap|];
...
Definition preserved_with_inv4 Q R :=
  forall x y z u, G (fun x y z u => P x y z u /\ Q x y z u /\ R x y z u) x y z u -> Q x y z u.
...
Ltac prove_ind4 :=
  ...
  match goal with [ |- ?G1_ /\ ?G2_ /\ ?G3_ ] =>
    pose (G1 := G1_);
    pose (Hmap := (ltac:(intros Q R H x y z u Hxyzu; destruct Hxyzu; constructor; try assumption; apply H; assumption) : G1));
    split; [exact Hmap|];
...
Definition preserved_with_inv5 Q R :=
  forall x y z u v, G (fun x y z u v => P x y z u v /\ Q x y z u v /\ R x y z u v) x y z u v -> Q x y z u v.
...
Proof.
  ...
  intros x y z u v H3 H4. apply H2.
...
Ltac prove_ind5 :=
  ...
  match goal with [ |- ?G1_ /\ ?G2_ /\ ?G3_ ] =>
    pose (G1 := G1_);
    pose (Hmap := (ltac:(intros Q R H x y z u v Hxyzuv; destruct Hxyzuv; constructor; try assumption; apply H; assumption) : G1));
    split; [exact Hmap|];
...
Definition preserved_with_inv6 Q R :=
  forall x y z u v w, G (fun x y z u v w => P x y z u v w /\ Q x y z u v w /\ R x y z u v w) x y z u v w -> Q x y z u v w.
...
Proof.
  ...
  intros x y z u v w H3 H4. apply H2.
...
Ltac prove_ind6 :=
  ...
  match goal with [ |- ?G1_ /\ ?G2_ /\ ?G3_ ] =>
    pose (G1 := G1_);
    pose (Hmap := (ltac:(intros Q R H x y z u v w Hxyzuvw; destruct Hxyzuvw; constructor; try assumption; apply H; assumption) : G1));
    split; [exact Hmap|];
